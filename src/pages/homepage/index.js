...
const Homepage = () => {
  ...
  return (
      ...
      {
        isVisible ? (
          <div onClick={scrollToTop} className={`duration-100 fixed z-[8989] w-[45px] h-[45px] lg:w-[60px] lg:h-[60px] right-[30px] lg:right-[50px] bottom-[70px] lg:bottom-[80px] rounded-full bg-mongo text-white flex items-center justify-center cursor-pointer shadow-lg`}>
