    ...
    {/* <div className='w-full lg:flex h-max pt-6 lg:pt-10 pb-12 overflow-hidden relative items-center justify-center bg-[#023430]'>
        ...
        <div className='w-[100%] lg:w-[50%] pl-[30px] lg:pl-[120px] h-screen pr-5 lg:pr-4 pt-1 lg:pt-3 pb-4 flex flex-col justify-center'>
            ...
            <div className='flex items-center'>
                ...
                <p className='hidden lg:inline text-red-300 line-through ml-5 text-[16px] relative top-[14px] '>Rp. 62.999</p>
                <p className='text-white ml-3 lg:ml-5 text-[22px] relative top-[14px] '>Rp. 49.000</p>
            </div>
        </div>
        <div className='w-[100%] lg:w-[50%] h-max lg:h-screen p-4 flex flex-col items-center justify-center'>
            <div className='z-10 overflow-hidden relative rounded-[20px] pl-4 pr-4 pb-4  pt-[35px] lg:pt-[45px] lg:mt-[0px] shadow-lg bg-darkMongo w-[96%] lg:w-[65%] h-max lg:h-[100%]'>
                <p className='text-lightMongo text-[13px] mb-5 ml-1 lg:ml-3 mt-4 lg:mt-3 font-normal'>Get started with :</p>
                <ul className='list-none'>
                    <li className='list-none mb-[40px] lg:mb-[50px] lg:ml-0 ml-[-20px] flex items-center'>
                    ...
                    <li className='list-none mb-[40px] lg:mb-[50px] lg:ml-0 ml-[-20px] flex items-center'>
                        ...
                        <p className='text-white ml-4 lg:ml-7 text-white text-[15px] lg:text-[17px] relative top-3 font-normal'>Lifetime access</p>
                    </li>
                    <li className='list-none mb-[40px] lg:mb-[50px] lg:ml-0 ml-[-20px] flex items-center'>
                        <div className='h-[15px] w-[25px] border-[#00ED64] rotate-[-45deg] border-l-[4px] border-b-[4px]'>
                        </div>
