...
const Hero = () => {
  ...
  return (
    <div className='text-center h-[100vh] flex items-center justify-center flex-col'>
      ...
      <h1 data-aos="fade-up" className='text-[44px] lg:text-[64px] w-[90%] lg:mt-[0] mt-[60px] lg:w-[60%]'>Brings <span className='text-indigo-500'>Speed</span> ​​in <span className='text-indigo-500'>creating</span> your <span className='text-indigo-500'>website.</span></h1>
      ...
      <a href="/dragmeBuilder" className='no-underline'>
        <Button text="Try dragme" padding={'lg:px-5 lg:py-3 px-4 py-2'} style={'font-normal mt-2'} />
      </a>
    </div>
  )
}
