...
const Hero = () => {
  ...
  return (
    <div className='text-center h-[100vh] flex items-center justify-center flex-col'>
      ...
      <h1 data-aos="fade-up" className='text-[44px] lg:text-[64px] w-[90%] lg:mt-[0] mt-[0px] lg:w-[60%]'>Brings <span className='text-indigo-500'>Speed</span> ​​in <span className='text-indigo-500'>creating</span> your <span className='text-indigo-500'>website.</span></h1>
